def data_node():
	...
	os.system("sshpass -p redhat ssh root@{} 'rm -r /datas'".format(ip_DN))
	os.system("sshpass -p redhat scp /etc/hadoop/core-site.xml root@{}:/etc/hadoop".format(ip_DN))
	os.system("sshpass -p redhat scp /root/project/datatask/hdfs-site.xml root@{}:/etc/hadoop".format(ip_DN))
	os.system("sshpass -p redhat scp /root/project/trackers/mapred-site.xml root@{}:/etc/hadoop".format(ip_DN))
	os.system("")
	...
	os.system("sshpass -p redhat scp /root/project/datatask/VERSION root@{}:/datas/current/ ".format(ip_DN))
